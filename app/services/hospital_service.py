...
class HospitalService:
    def get_by_id(self, db: Session, hospital_id: str) -> Hospital:
    ...
    def create(self, db: Session, hospital_in: HospitalCreate, created_by: str) -> Hospital:
    ...
    def update(
        self, db: Session, hospital_id: str, hospital_in: HospitalUpdate, updated_by: str
    ) -> Hospital:
    ...
    def delete(self, db: Session, hospital_id: str) -> Hospital:
